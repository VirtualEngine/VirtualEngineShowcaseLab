configuration vShowcaseLabAccdbOdbc {
    ...
    $registryValues = @(
        @{
            ...
            ValueName = 'SO_Data_Reader';
            ValueType = 'String';
            ValueData = 'Microsoft Access Driver (*.mdb, *.accdb)';
        }
        @{
            Key       = 'HKEY_LOCAL_MACHINE\SOFTWARE\ODBC\ODBC.INI\SO_Data_Reader';
            ValueName = 'Driver';
            ValueType = 'String';
            ValueData = 'C:\\PROGRA~1\\COMMON~1\\MICROS~1\\OFFICE14\\ACEODBC.DLL';
        }
        @{
            Key       = 'HKEY_LOCAL_MACHINE\SOFTWARE\ODBC\ODBC.INI\SO_Data_Reader';
            ValueName = 'DBQ';
            ValueType = 'String';
            ValueData = $AccdbDatabasePath;
        }
        @{
            Key       = 'HKEY_LOCAL_MACHINE\SOFTWARE\ODBC\ODBC.INI\SO_Data_Reader';
            ValueName = 'DriverId';
        ...
        @{
            Key       = 'HKEY_LOCAL_MACHINE\SOFTWARE\ODBC\ODBC.INI\SO_Data_Reader\Engines\Jet';
            ValueName = 'ImplicitCommitSync';
            ValueType = 'String';
            ValueData = '';
        }
        @{
            Key       = 'HKEY_LOCAL_MACHINE\SOFTWARE\ODBC\ODBC.INI\SO_Data_Reader\Engines\Jet';
            ValueName = 'MaxBufferSize';
            ValueType = 'Dword';
            ValueData = '2048';
        }
        @{
            Key       = 'HKEY_LOCAL_MACHINE\SOFTWARE\ODBC\ODBC.INI\SO_Data_Reader\Engines\Jet';
            ValueName = 'PageTimeout';
            ValueType = 'Dword';
            ValueData = '5';
        }
        @{
